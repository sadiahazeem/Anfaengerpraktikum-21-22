...
plt.xlabel(r'$Lx^2 - \frac{x^3}{3} \mathbin{/} \unit{\mm\cubed}$', labelpad = 1.0)
plt.ylabel(r'$D(x) \mathbin{/} \unit{\mm}$', labelpad = 1.0)
plt.legend(loc='best')
...
plt.xlabel(r'$3L^2x - 4x^3 \mathbin{/} \unit{\mm\cubed}$', labelpad = 1.0)
plt.ylabel(r'$D(x) \mathbin{/} \unit{\mm}$', labelpad = 1.0)
plt.legend(loc='best')
