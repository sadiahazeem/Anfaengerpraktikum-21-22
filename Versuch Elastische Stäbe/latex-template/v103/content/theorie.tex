...
\begin{figure}[H]
    ...
    \caption{Funktionsweise der einseitigen Einspannung des Stabes. \\Quelle: \cite{sample}}  % QUELLE 
...
\begin{figure}[H]
    ...
    \caption{Die wirkenden Kräfte bei einseitiger Einspannung. Quelle: \cite{sample}}  % QUELLE
    \label{fig:InnerStab}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Ein Stab bei beidseitiger Auflage. Quelle: \cite{sample}}  % QUELLE
    \label{fig:StabBeid}
\end{figure}
