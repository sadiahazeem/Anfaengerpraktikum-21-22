...
\section{Zielsetzung}
Ziel des Versuches ist, die Wärmeleitfähigkeit der Proben aus Messing, Edelstahl und Aluminium 
zu untersuchen, sowie die spezifischen Wärmeleitkoeffizienten zu bestimmen. \\
\section{Theorie}
\label{sec:Theorie} 
Die Wärmeleitung eines Festkörpers ist ein Phänomen, das auftritt, wenn sich ein selbiger nicht im Temperaturgleichgewicht
befindet. \\
Es findet ein Wärmeaustausch durch Phononen und freie Elektronen nach dem 2. Hauptsatz der Thermodynamik entlang des Temperaturgefälles statt.
Die Wärmemenge $dQ$, die in einer Zeit $dt$ in einem Stab der Länge $x$, mit Dichte $\rho$, Querschnitt $A$ und spezifischer Wärme $c$ fließt, ist durch
\begin{equation}
