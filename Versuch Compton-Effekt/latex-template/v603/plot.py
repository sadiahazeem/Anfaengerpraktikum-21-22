...
t, N = np.genfromtxt('EmissionCu.dat', delimiter = ',', unpack=True)
...
#plot
plt.figure()
plt.plot(t, N, 'xr', label='Messwerte Emissionsspektrum')
...
t_al , N_al = np.genfromtxt('ComptonAl.txt', unpack=True)
t_0  , N_0  = np.genfromtxt('ComptonOhne.txt', unpack=True)
...
plt.plot(lamd_plot, params2[0]*lamd_plot + params2[1], 'b-', label='Lineare Regression')
